...
const DEV = 'b914f5cd-35f8-4fa3-9e5f-2d2dc19ed953';
...
async function main() {
  ...
  E('main', cap('frontseats'), 'fl', seat(cl.seat_heater_left)); E('main', cap('frontseats'), 'fr', seat(cl.seat_heater_right));
  E('main', cap('rearseats'), 'rl', seat(cl.seat_heater_rear_left)); E('main', cap('rearseats'), 'rc', seat(cl.seat_heater_rear_center)); E('main', cap('rearseats'), 'rr', seat(cl.seat_heater_rear_right));
